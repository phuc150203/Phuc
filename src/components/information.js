            ...
            <div className="container">
                ...
                <aside className="col-lg-6 imgpro">
                    ...
                    <a data-fslightbox="mygalley" className="border mx-1 rounded-2" target="_blank" >
                        <img  className="rounded-2" src="o1.png" />
                    </a>
                    <a data-fslightbox="mygalley" className="border mx-1 rounded-2" target="_blank" >
                        <img  className="rounded-2" src="o2.png" />
                    </a>
                    <a data-fslightbox="mygalley" className="border mx-1 rounded-2" target="_blank" >
                        <img  className="rounded-2" src="o3.png" />
                    </a>
                    </div>
                    <div className="d-flex justify-content-center mb-3">
                    <a data-fslightbox="mygalley" className="border mx-1 rounded-2" target="_blank" >
                        <img  className="rounded-2" src="o4.png" />
                    </a>
                    <a data-fslightbox="mygalley" className="border mx-1 rounded-2" target="_blank" >
                        <img  className="rounded-2" src="o7.png" />
                    </a>
                    <a data-fslightbox="mygalley" className="border mx-1 rounded-2" target="_blank" >
                        <img  className="rounded-2" src="o8.png" />
                    </a> 
                    </div>
                </aside>
                <main className="col-lg-6 ">
                    ...
                    <h4 className="title text-dark">
                        Compo ONE PIECE limited edition.
                    </h4>
                    ...
                    <div className="row">
                        ...
                        <dt className="col-3">Imformation</dt>
                        <dd className="col-9"></dd>
                    </div>
